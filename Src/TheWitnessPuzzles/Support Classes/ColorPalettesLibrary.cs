...
namespace GameManager
{
    public static class ColorPalettesLibrary
    {
        ...
        public static readonly ColorPalette[] Palettes =
        {
            ...
            new ColorPalette(new Color(86,120,110), new Color(0,33,12), new Color(86,120,110),
            ...
            new ColorPalette(new Color(103,93,77), new Color(40,30,23), new Color(103,93,77),
            ...
            new ColorPalette(new Color(127,124,113), new Color(60,60,60), new Color(127,124,113),
