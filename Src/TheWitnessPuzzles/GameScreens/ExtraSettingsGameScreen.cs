    ...
    public class ExtraSettingsGameScreen : GameScreen
    {
        ...
        private void SpawnButtons()
        {
            ...
            btnResetSequential.Click += () => {
                Game1._screenManager.AddScreen<ConfirmSeedResetGameScreen>(false, true);
            ...
            btnBack.UpdateButton += () => {
                btnBack.SetPositionAndSize(new Point(buttonsArea.X, ScreenSize.Y - buttonHeight * 2),
                    new Point(buttonsArea.Width, (int)(buttonHeight * 1.5f)));
            };
            buttons.Add(btnBack);
